...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Smart Videos`}</title>

        <meta
          name="description"
          content="Experience the Power of Customization with Smart Videos - Your Ultimate Solution for Generating and Customizing Video Player Code Tailored to Your User Actions."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1540591813291-4a54b35cb33d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx2aWRlbyUyMHBsYXllcnxlbnwwfHx8fDE2OTY0MDcwMzJ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@tsellobenok?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Dzmitry Tselabionak`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the Power of Customization with Smart Videos - Your Ultimate Solution for Generating and Customizing Video Player Code Tailored to Your User Actions.`}
            </Text>
            <Box
