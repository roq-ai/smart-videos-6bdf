...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'administrator', 'developer', 'designer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Actions', path: '/actions', entity: 'action', service: AccessServiceEnum.PROJECT, icon: FiActivity },
    { name: 'Clicks', path: '/clicks', entity: 'click', service: AccessServiceEnum.PROJECT, icon: FiMousePointer },
